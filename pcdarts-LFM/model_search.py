...
def initialize_alphas(steps=4):
    ...
    return _arch_parameters, alphas_normal, alphas_reduce, betas_normal, betas_reduce
...
class Network(nn.Module):
    ...
    def new(self):
        ...
        model_new._arch_parameters = arch
        model_new.alphas_normal = alphas_normal
        model_new.alphas_reduce = alphas_reduce
        model_new.betas_normal = betas_normal
        model_new.betas_reduce = betas_reduce
